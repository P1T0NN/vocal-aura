    ...
    return (
        ...
        >
            <Link href="/" className="block">
                <svg id="Capa_2" data-name="Capa 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 938.59 518.38" className="w-32 h-auto">
                    <defs>
                        <style>{`
                            .cls-1 {
                                fill: #fd792d;
